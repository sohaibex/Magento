...
class Interceptor extends \Magento\Email\Model\BackendTemplate implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSystemConfigPathsWhereCurrentlyUsed');
        return $pluginInfo ? $this->___callPlugins('getSystemConfigPathsWhereCurrentlyUsed', func_get_args(), $pluginInfo) : parent::getSystemConfigPathsWhereCurrentlyUsed();
    }
