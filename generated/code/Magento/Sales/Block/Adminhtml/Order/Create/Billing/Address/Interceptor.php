...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Billing\Address implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHeaderText');
        return $pluginInfo ? $this->___callPlugins('getHeaderText', func_get_args(), $pluginInfo) : parent::getHeaderText();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHeaderCssClass');
        return $pluginInfo ? $this->___callPlugins('getHeaderCssClass', func_get_args(), $pluginInfo) : parent::getHeaderCssClass();
    }
    ...
    public function getFormValues()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFormValues', func_get_args(), $pluginInfo) : parent::getFormValues();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressId');
        return $pluginInfo ? $this->___callPlugins('getAddressId', func_get_args(), $pluginInfo) : parent::getAddressId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressCollectionJson');
        return $pluginInfo ? $this->___callPlugins('getAddressCollectionJson', func_get_args(), $pluginInfo) : parent::getAddressCollectionJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressAsString');
        return $pluginInfo ? $this->___callPlugins('getAddressAsString', func_get_args(), $pluginInfo) : parent::getAddressAsString($address);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreateOrderModel');
        return $pluginInfo ? $this->___callPlugins('getCreateOrderModel', func_get_args(), $pluginInfo) : parent::getCreateOrderModel();
    }
    ...
    public function formatPrice($value)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('formatPrice', func_get_args(), $pluginInfo) : parent::formatPrice($value);
    }

    /**
     * {@inheritdoc}
     */
    public function getItemPrice(\Magento\Catalog\Model\Product $product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemPrice');
        return $pluginInfo ? $this->___callPlugins('getItemPrice', func_get_args(), $pluginInfo) : parent::getItemPrice($product);
    }
    ...
    public function convertPrice($value, $format = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('convertPrice', func_get_args(), $pluginInfo) : parent::convertPrice($value, $format);
    }
    ...
    public function getProduct($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProduct', func_get_args(), $pluginInfo) : parent::getProduct($item);
    }
